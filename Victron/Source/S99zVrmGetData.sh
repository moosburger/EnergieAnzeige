...
#
# Das zu startende Script (S99zVrmGetData.sh) liegt /etc/init.d
#
###########################################################
#
###########################################################
...
PATH=$PATH:/mnt/dietpi_userdata/EnergieAnzeige:/etc/init.d:
HOME=/root

# Configured Variables:
PYTHON_EXEC="python"
SCRIPT_EXEC="/mnt/dietpi_userdata/EnergieAnzeige/VrmGetData.py"
